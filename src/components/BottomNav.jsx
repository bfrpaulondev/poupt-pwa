...
import { LayoutDashboard, PiggyBank, MessageCircle, CreditCard, User } from 'lucide-react';

const navItems = [
  { id: 'dashboard', icon: LayoutDashboard, label: 'Dashboard' },
  { id: 'jars', icon: PiggyBank, label: 'Frascos' },
  { id: 'coach', icon: MessageCircle, label: 'Coach' },
  { id: 'debts', icon: CreditCard, label: 'Dividas' },
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around py-2 px-2"
